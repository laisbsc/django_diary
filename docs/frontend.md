...
> For all design decisions — colours, typography, components, voice — refer to [`brand.md`](brand.md). That is the single source of truth. This file covers dev conventions only.
